	...
	<body>
		<div id="content">
			...
			<div style="border-top:solid white; border-left:solid black; border-right:solid black; border-bottom:solid black" class="maincontent">
				<h2>Ο Σύνδεσμος</h2>	
				<ul class="bullet">
					<li><a href="o-syndesmos\istoriko.php">Ιστορικό</a></li>
					<li><a href="o-syndesmos\ektelestiki-epitropi.php">Εκτελεστική Επιτροπή</a></li>
					<li><a href="o-syndesmos\melh.php">Μέλη</a></li>
					<li><a href="o-syndesmos\katastatiko.php">Καταστατικό</a></li>
					<li><a href="o-syndesmos\egrafa.php">Έγγραφα</a></li>
				</ul>
			</div>
			<footer>
